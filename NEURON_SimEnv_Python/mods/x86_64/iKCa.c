...
#define evaluate_fct evaluate_fct__iKCa 
#define states states__iKCa 
...
extern void hoc_reg_nmodl_filename(int, const char*);
 ...
 "evaluate_fct_iKCa", _hoc_evaluate_fct,
 0, 0
};
 /* declare global and static user variables */
#define beta beta_iKCa
 double beta = 0.03;
#define cac cac_iKCa
 double cac = 0.003;
#define taumin taumin_iKCa
 double taumin = 1;
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 4, "cvodeieq");
 	...
 	ivoc_help("help ?1 iKCa /home/ncn-neuron/Documents/GitHub/neuromodulation-RL/mods/iKCa.mod\n");
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/ncn-neuron/Documents/GitHub/neuromodulation-RL/mods/iKCa.mod";
static const char* nmodl_file_text = 
  ...
  ":   \n"
  ":   Modifications by Eduardo Carvalho: \n"
  ":           - cac changed from 0.001 to 0.003\n"
  ":           - taumin changed from 0.1 to 1\n"
  "\n"
  "\n"
  ...
  "    cac     = 0.003   (mM)            : middle point of activation fct    \n"
