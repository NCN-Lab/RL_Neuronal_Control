...
#define nrn_init _nrn_init__Exp2NMDAR
#define _nrn_initial _nrn_initial__Exp2NMDAR
#define nrn_cur _nrn_cur__Exp2NMDAR
#define _nrn_current _nrn_current__Exp2NMDAR
#define nrn_jacob _nrn_jacob__Exp2NMDAR
#define nrn_state _nrn_state__Exp2NMDAR
#define _net_receive _net_receive__Exp2NMDAR 
#define state state__Exp2NMDAR 
...
#define _f_mgblock _f_mgblock_Exp2NMDAR
#define mgblock mgblock_Exp2NMDAR
 extern double _f_mgblock( double );
 extern double mgblock( double );
 /* declare global and static user variables */
#define total total_Exp2NMDAR
 double total = 0;
#define usetable usetable_Exp2NMDAR
 double usetable = 1;
 /* some parameters have upper and lower limits */
 static HocParmLimits _hoc_parm_limits[] = {
 "tau2", 1e-09, 1e+09,
 "tau1", 1e-09, 1e+09,
 "usetable_Exp2NMDAR", 0, 1,
 0,0,0
};
 ...
 "total_Exp2NMDAR", &total_Exp2NMDAR,
 "usetable_Exp2NMDAR", &usetable_Exp2NMDAR,
 0,0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 pnt_receive_size[_mechtype] = 1;
 	...
 	ivoc_help("help ?1 Exp2NMDAR /home/ncn-neuron/Documents/GitHub/neuromodulation-RL/mods/exp2nmdar.mod\n");
 hoc_register_limits(_mechtype, _hoc_parm_limits);
 hoc_register_units(_mechtype, _hoc_parm_units);
 }
 static double *_t_mgblock;
static int _reset;
static char *modelname = "dual-exponential model of NMDA receptors";
...
{
 { error =  state();
 if(error){fprintf(stderr,"at line 99 in file exp2nmdar.mod:\n\n"); nrn_complain(_p); abort_run(error);}
 }}}
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/ncn-neuron/Documents/GitHub/neuromodulation-RL/mods/exp2nmdar.mod";
static const char* nmodl_file_text = 
  "\n"
