...
Code is available in folder ***NEURON_SimEnv_Python***. You need NEURON simulation environment installed ( https://www.neuronsimulator.org/ ) to run this code. Example code is provided (/NEURON_SimEnv_Python/examples/, see specific Readme.md file for more information), with execution time of a few minutes.
